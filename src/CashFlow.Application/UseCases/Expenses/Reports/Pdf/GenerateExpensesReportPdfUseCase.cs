...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses)
        {
            ...
            if (!string.IsNullOrWhiteSpace(expense.Description))
            {
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Color = ColorsHelper.BLACK, Size = 10 };
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Rafael Villaça";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "ProfilePhoto_Compat.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, Rafael Villaça");
    ...
    private void AddExpenseTitle(Cell cell, string expenseTitle)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Color = ColorsHelper.BLACK, Size = 14 };
    ...
    private void AddHeaderForAmount(Cell cell)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Color = ColorsHelper.WHITE, Size = 14 };
    ...
    {
        cell.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Color = ColorsHelper.BLACK, Size = 12 };
    ...
    private void AddAmountForExpense(Cell cell, decimal amount)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Color = ColorsHelper.BLACK, Size = 14 };
